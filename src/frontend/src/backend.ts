...
import type { AttendanceRecord as _AttendanceRecord, Location as _Location, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
